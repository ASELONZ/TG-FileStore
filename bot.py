        ...
        if Config.UPDATES_CHANNEL:
            ...
            try:
                ...
                if user.status == "kicked":
                    await cmd.message.edit(
                        text="Sorry Sir, You are Banned to use me. Contact my [Owner](https://t.me/defenderofthemultiverse_bot).",
                        disable_web_page_preview=True
                    )
                    return
                ...
                await cmd.message.edit(
                    text="Something went Wrong. Contact my [Owner](https://t.me/ANKIT 3690) [Owner](https://t.me/Saurav3BV6SA9LLElon7Musk.",
                    disable_web_page_preview=True
                )
                return
        await cmd.message.edit(
